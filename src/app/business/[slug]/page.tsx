            ...
            {business.phone || business.email_contact || business.website ? (
              <div data-testid="business-contact" className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-5 space-y-3">
                  {business.phone && (
                    <ContactReveal businessId={business.id} type="phone" value={business.phone} />
                  )}
                  {business.email_contact && (
                    <ContactReveal businessId={business.id} type="email" value={business.email_contact} />
                  )}
                  {business.website && (
                    <ContactReveal businessId={business.id} type="website" value={business.website} />
                  )}
                </div>
